...
flatpak-builder --repo=repo rust-sdk org.freedesktop.Sdk.Extension.rust-120.json
...
#flatpak --user install fractal-repo org.freedesktop.Sdk.Extension.rust-120
